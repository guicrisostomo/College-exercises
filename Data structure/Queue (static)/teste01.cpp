...
int main() {
    ...
    //cout << fila02.listar();
    cout << minhaFila.primeiro(x) << " " << x << endl;
    minhaFila.inverter();
    cout << minhaFila.estaNaFila(y) << endl;
    fila02 = minhaFila.uniao(fila01);
    cout << fila02.listar() << endl;
    //cout << minhaFila.tamanho() << endl;
    //cout << minhaFila.ultimo(x) << " " << x << endl;
    //cout << minhaFila.ultimo(x) << " " << x << endl;
}
