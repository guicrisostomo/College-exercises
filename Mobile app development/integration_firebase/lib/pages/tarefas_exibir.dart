...
class TarefasExibir extends StatefulWidget {
  final tarefas;
  final cor;
  final icone;
  final status;

  const TarefasExibir(this.tarefas, this.cor, this.icone, this.status,
      {Key? key})
      : super(key: key);

  @override
  State<TarefasExibir> createState() => _TarefasExibirState();
}

class _TarefasExibirState extends State<TarefasExibir> {
  @override
